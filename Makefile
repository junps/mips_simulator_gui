...
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile mips_simulator_gui.pro DEFINES=NOT_FPU=1
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DNOT_FPU=1 -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
Makefile: mips_simulator_gui.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile mips_simulator_gui.pro DEFINES=NOT_FPU=1
...
distdir: FORCE
	...
	$(COPY_FILE) --parents instruction.h mainwindow.h no_gui.h simu_functions.h simulator.h $(DISTDIR)/
	$(COPY_FILE) --parents instruction.cpp main.cpp mainwindow.cpp no_gui.cpp simu_functions.cpp $(DISTDIR)/
